...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": aktiviraj za rastući poredak",sSortDescending:": aktiviraj za padajući poredak"},oPaginate:{sFirst:"Prva",sLast:"Zadnja",
sNext:"Naprijed",sPrevious:"Nazad"},sEmptyTable:"Nema podataka u tablici",sInfo:"Prikazano _START_ do _END_ od _TOTAL_ rezultata",sInfoEmpty:"Prikazano 0 do 0 od 0 rezultata",sInfoFiltered:"(filtrirano iz _MAX_ ukupnih rezultata)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Prikaži _MENU_ rezultata",sLoadingRecords:"Dohvaćam...",sProcessing:"Obrađujem...",sSearch:"<i class='fa-solid fa-magnifying-glass text-primary'></i>",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Ništa nije pronađeno"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
