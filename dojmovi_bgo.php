...
<div class="container my-5 h-100">
	...
	<div class="d-flex flex-wrap mb-3">
		...
		<a class="btn btn-warning text-secondary m-2 shadow-sm" href="dojmovi_bgo.php">Vježbanje <span class="fw-bold">Basic Gym One</span></a>
		<a class="btn btn-outline-warning text-secondary m-2 shadow-sm" href="dojmovi_hc.php">Rehabilitacija <span class="fw-bold">Fizio One</span></a>
	</div>
