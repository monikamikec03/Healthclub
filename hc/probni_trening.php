...
{	
	...
	$red = "SELECT COUNT(id_prijave) AS broj_kupaca FROM prijava_probni_trening";			
		...
		<table id="table_id" class="table table-hover table-stripped border-light DataTable">  
			...
			while($red = mysqli_fetch_array($res)) 
			{
				...
				<tr>
					...
					<td><b><a href='prikaz_prijave_t.php?id=<?php echo $id; ?>'><?php echo $ime_prezime; ?></a></b></td>			
					<td><?php echo $email; ?></td>						
					<td><?php echo $broj_mobitela; ?></td>		
					<td><?php echo $naziv_artikla . " [".$naziv_jed_mjere."]"; ?></td>		
